...
![app icon](android/app/src/main/play_store_512.png)
...
<!-- ![dark mode device screen](screenshots_for_readme/dark_mode_device_screen.jpg) -->
<img src="screenshots_for_readme/dark_mode_device_screen.jpg" alt="dark mode device screen" width=400>

![dark mode scan screen](screenshots_for_readme/dark_mode_scan_screen.jpg)

### BRIGHTNESS WARNING: LIGHT MODE SCREENSHOT INCOMING
![light mode device screen](screenshots_for_readme/light_mode_device_screen.jpg)
![light mode mode device screen](screenshots_for_readme/light_mode_device_screen.jpg)
